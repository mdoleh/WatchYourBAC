System.register(['angular2/core', './BeerService', './Constants', 'angular2/router'], function(exports_1) {
    ...
    var core_1, BeerService_1, Constants_1, router_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        { path: '/', name: 'Info', component: AppComponent },
                        { path: '/search', name: 'BeerSearch', component: HeroListComponent },
                        { path: '/beer/:id', name: 'BeerDetail', component: HeroDetailComponent },
                        { path: '/consumed', name: 'Consumed', component: HeroDetailComponent }
                    ]), 
                    __metadata('design:paramtypes', [BeerService_1.BeerService])
                ], AppComponent);
                return AppComponent;
            })();
